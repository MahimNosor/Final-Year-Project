...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.bham.finalyearproject.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.bham.finalyearproject.repository.UserRepository.USERS_BY_EMAIL_CACHE);
