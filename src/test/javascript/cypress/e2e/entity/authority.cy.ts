...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'b7c67c4c-71e5-471c-8a54-744f1f7758ab' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('0511d5a8-64ab-4891-99c4-9217affe3d7c');
      cy.get(`[data-cy="name"]`).should('have.value', '0511d5a8-64ab-4891-99c4-9217affe3d7c');
